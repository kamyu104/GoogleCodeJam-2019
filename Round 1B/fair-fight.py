...
def fair_fight():
    ...
    for i in reversed(xrange(N)):
        ...
        D_R_good = D_curr_max_idxs[D_R_good_it-1]-1 if D_R_good_it > 0 else N-1  # get the rightmost idx of max_D s.t. max_D-Ci <= K
        D_R_bad = D_curr_max_idxs[D_R_bad_it-1]-1 if D_R_bad_it > 0 else N-1  # get the rightmost idx of max_D s.t. max_D-Ci <= -K-1
