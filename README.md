...
|D| [Napkin Folding](https://codingcompetitions.withgoogle.com/codejam/round/0000000000051707/0000000000159170)| [Python](./Round%203/napkin-folding.py) | _O(N^2 * K^2)_ | _O(N * K^2)_ | Very Hard | | Geometry, Sliding Window, BFS, DFS |
